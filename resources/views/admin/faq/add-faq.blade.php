        ...
        <div class="col-sm-10 col-sm-offset-1">
            <div class="well">
                ...
                @if(Session::get('message'))
                    ...
                    <hr/>
                @else
                    <h2 style="text-align: center;color: blue;font-weight: 700;">ADD FAQ</h2>
                    <hr/>
                @endif

                <form action="{{ url('/new-faq') }}" method="POST" class="form-horizontal">
                    {{ csrf_field() }}
                    ...
                    <div class="form-group">
                        <div class="col-sm-9 col-sm-offset-3">
                            <input type="submit" name="btn" class="btn btn-success btn-block" value="Save FAQ Info"/>
                        </div>
                    </div>
                </form>
            </div>
